class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Введите начальные координаты X главного персонажа:");
        int playerX = int.Parse(Console.ReadLine());

        Console.WriteLine("Введите начальные координаты Y главного персонажа:");
        ...
        for (int i = 0; i < enemies.Length; i++)
        {
            ...
            Console.WriteLine($"Введите начальные координаты X врага {i + 1}:");
            int enemyX = int.Parse(Console.ReadLine());

            Console.WriteLine($"Введите начальные координаты Y врага {i + 1}:");
        ...
        while (!exitGame)
        {
            ...
            Console.WriteLine("2. Переместиться");
            ...
            switch (choice)
            {
                case 1:
                    //Атака врага
                    Console.WriteLine("Выберите врага для атаки (введите номер от 1 до {numberOfEnemies}):");
                ...
                case 4:
                    ...
                    Console.WriteLine("Выберите персонажа для сверки (введите номер от 1 до {numberOfEnemies}):");
